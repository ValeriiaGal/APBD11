...
{
    /// <inheritdoc />
    public partial class DeviceSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__DeviceTy__737584F6F7E4D451",
                table: "DeviceType",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Person__45809E71952159A7",
                table: "Person",
                column: "PassportNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__85FB4E3894F9A8AD",
                table: "Person",
                column: "PhoneNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__A9D105347F1710D9",
                table: "Person",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Position__737584F6D2FC835A",
                table: "Position",
                column: "Name",
                unique: true);
        }
